    ...
    <body>
        ...
        <div class="page">
            <table width="100%" cellspacing="0" border="1">
                <caption>Карпуля Ярослав Євгенійович</caption>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="col-4">Телефон: +3(098)726-07-98<br>
                            E-mail: slavaooo@soborka.net</td>
                    </tr>
                    <tr>
                        <td class="col-5">Образование:</td>
                        <td class="col-6">одеська державна академія холоду</td>
                    </tr>
                    <tr>
                        <td class="col-5">Досвід роботи та професійні навички:</td>
                        <td class="col-6">з жовтня 2007р головний спеціаліст відділу адміністрування, супроводження інформаційних систем,
                    ...
                    <tr>
                        ...
                        <td class="col-6">Англійська мова - вільне володіння<br>
