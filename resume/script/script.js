...
var education = new Education("Південноукраїнський державний педагогічний університет ім. К.Д.Ушинського");
var skill = new Skill("JavaScript, JQuery, HTML, CSS, MySQL", "Windows 10, 8, 8.1, 7, XP; Linux", "Java Javafx");
...
function setText(elem, key) {
    switch (key) {
        ...
        case 3:
            $(elem).empty();
            $(elem).append($("<p></p>").text(experience.last));
            break;
        case 4:
            $(elem).empty();
